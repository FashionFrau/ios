//
//  FFEsRefreshHeaderAnimator.swift
//  fashionfrau
//
//  Created by Nilson Junior on 10.05.17.
...
open class FFRefreshHeaderAnimator: UIView, ESRefreshProtocol, ESRefreshAnimatorProtocol, ESRefreshImpactProtocol {
